...
{
    public class DischargeSummaryTempGenerator: ReportGenerator, IReportGenerator
    {
        ...
        public DischargeSummaryTempGenerator(IWebHostEnvironment environment, IReportsDataService reportsDataService, IRazorLightEngine razorEngine, IPDFHelper pDFHelper) : base(razorEngine, pDFHelper)
        {
